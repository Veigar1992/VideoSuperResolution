...
class HDRDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        self.paths_GT = [
            v for v in self.paths_GT if v.split('_')[0] not in ['25751677', '67933483', '92032300',
                         '92035015', '73859339', '91469988', '48712272', '44905938', '32129750',
                         '70157184', '66522103', '19869273', '32791289', '55140422']
        ]
    ...
    def __getitem__(self, index):
        ...
        #### get LQ images
        LQ_size_tuple = (3, 540, 960) if self.LR_input else (3, 720, 1280)
        img_LQ_l = []
        ...
        if self.opt['phase'] == 'train':
            C, H, W = LQ_size_tuple  # LQ size (3, 540, 960)
            # randomly crop
            if self.LR_input:

                LQ_size = GT_size // scale# 64 = 256 // 4

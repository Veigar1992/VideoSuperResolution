...
def main():
    ...
    if dataset == 'vimeo90k':
        ...
        test_lmdb('../../datasets/HDR/train/lmdb/train_540.lmdb', 'HDR')
...
def hdr4k(mode):
    ...
    GT: [3, 720, 1280], key: 00000000_00000000
    LR: [3, 180, 320], key: 00000000_00000000
    key: 000_00000000
    ...
    BATCH = 5000  # After BATCH images, lmdb commits, if read_all_imgs = False
    if mode == 'GT':
        img_folder = '../../datasets/HDR/train/new_method/pngs/SDR_4K'
        lmdb_save_path = '../../datasets/HDR/train/new_method/pngs'
        H_dst, W_dst = 2160, 3840
    elif mode == 'LR':
        img_folder = '../../datasets/HDR/train/sequences_540'
        lmdb_save_path = '../../datasets/HDR/train/lmdb/train_540.lmdb'
        H_dst, W_dst = 540, 960
    n_thread = 40
    ########################################################
    # if not lmdb_save_path.endswith('.lmdb'):
    ...
    #### create meta information
    meta_info = {}
    meta_info['name'] = 'HDR4K_{}'.format(mode)
